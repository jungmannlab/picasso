...
Last change: 07-AUG-2025 MTS

0.8.1 - 0.8.2
-------------
- Added docstrings and data types for all functions in ``postprocess``, ``simulate``, ``render``, ``nanotron``, ``localize``, ``lib``, ``io``, ``imageprocess``, ``gaussmle`` and ``zfit``
