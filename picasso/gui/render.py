...
class Window(QtGui.QMainWindow):
    ...
    def open_apply_dialog(self):
        ...
        cmd, ok = QtGui.QInputDialog.getText(self, 'Apply expression', 'Pre-defined variables: {}'.format(vars))
        if ok:
            exec(cmd, {k: self.view.locs[0][k] for k in vars})
    ...
    def save_locs(self):
        ...
        if path:
            ...
            io.save_locs(path, self.view.locs[0], info)
