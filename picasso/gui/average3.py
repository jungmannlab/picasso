...
class Window(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        displaygrid.addWidget(QtGui.QLabel('XZ'), 1, 0)
        displaygrid.addWidget(QtGui.QLabel('YZ'), 0, 1)
        displaygrid.addWidget(QtGui.QLabel('Convergence Plot'), 1, 1)
